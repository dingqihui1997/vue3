    ...
    <div class="wi100">
      ...
      <el-tabs v-model="activeName">
        <el-tab-pane label="基础设置" name="1">
          <tab1 @send="send" :activeName="activeName"></tab1>
        </el-tab-pane>
        <el-tab-pane label="媒体信息" name="2">
          <tabtwo @send="send" :activeName="activeName"></tabtwo>
        </el-tab-pane>
        <el-tab-pane label="商品规格" name="3">
          <tabsku @send="send" :activeName="activeName"></tabsku>
        </el-tab-pane>
        <el-tab-pane label="商品详情" name="4">
          <addDetails @send="send" :activeName="activeName"></addDetails>
        </el-tab-pane>
      </el-tabs>
    </div>
  </el-card>
