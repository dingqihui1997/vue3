<template>
  <el-card v-if="show">
    ...
    <img
      src="http://lp-disk.oss-cn-chengdu.aliyuncs.com/egg-oss-demo/a3xuglufsg80000.jpg"
      alt=""
    />
  </el-card>
  <el-card v-else>
    <div class="wi100">
      ...
      <el-tabs v-model="activeName">
        ...
        <el-tab-pane label="商品规格" name="3">角色管理</el-tab-pane>
        <el-tab-pane label="商品详情" name="4">定时任务补偿</el-tab-pane>
      </el-tabs>
    </div>
  </el-card>
</template>
