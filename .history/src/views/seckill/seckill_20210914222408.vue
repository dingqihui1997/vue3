<template>
  ...
  >
    <el-form :model="form" :rules="rules" ref="submit" style="padding: 10px">
      <el-form-item label="优惠券名称" prop="name" class="mar-l-15">
        <el-input v-model="form.name"></el-input>
      </el-form-item>
      <el-form-item label="使用门槛" prop="amount">
        <el-input v-model="form.amount"></el-input>
      </el-form-item>
      <el-form-item label="优惠金额" prop="threshold">
