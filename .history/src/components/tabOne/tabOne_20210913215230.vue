...
let rules = ref<any>({
  name: [{ required: true, message: "图片为必传项", trigger: "blur" }],
  category: [{ required: true, message: "导航标题为必传项", trigger: "blur" }],
  originalPrice: [
    { required: true, message: "导航标题为必传项", trigger: "blur" },
  ],
  presentPrice: [
    { required: true, message: "导航标题为必传项", trigger: "blur" },
  ],
  cover: [{ required: true, message: "导航标题为必传项", trigger: "blur" }],
  company: [{ required: true, message: "导航标题为必传项", trigger: "blur" }],

  stock: [{ required: true, message: "导航标题为必传项", trigger: "blur" }],
  introduction: [
    { required: true, message: "导航标题为必传项", trigger: "blur" },
  ],
  sellDesc: [{ required: true, message: "导航标题为必传项", trigger: "blur" }],
});
