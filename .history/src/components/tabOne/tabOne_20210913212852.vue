<template>
  <div>
    <el-form :model="form" :rules="rules" ref="submit">
      ...
      <el-form-item label="商品原价:" prop="title">
        <el-input v-model="form.title"></el-input>
      </el-form-item>
      <el-form-item label="商品现价:" prop="title">
        <el-input v-model="form.title"></el-input>
      </el-form-item>
      ...
      <el-form-item label="商品单位:" prop="title">
        <el-input v-model="form.title"></el-input>
      </el-form-item>
      <el-form-item label="商品库存:" prop="title">
        <el-input v-model="form.title"></el-input>
      </el-form-item>
      <el-form-item label="商品简介:" prop="title">
        <el-input v-model="form.title"></el-input>
      </el-form-item>
      <el-form-item label="推荐介绍:" prop="title">
        <el-input v-model="form.title"></el-input>
      </el-form-item>
      <el-form-item label="是否新品:" prop="title">
        <el-switch></el-switch>
      </el-form-item>
      <el-form-item label="是否热销:" prop="title">
        <el-switch></el-switch>
      </el-form-item>
